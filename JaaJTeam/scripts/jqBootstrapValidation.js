    ...
    let defaults = {
        ...
        methods: {
            init: function (options) {
                ...
                return this.each(function () {
                    ...
                    const $this = $(this),
                        $controlGroup = $this.parents(".control-group").first();
                    let $helpBlock = $controlGroup.find(".help-block").first();
                    ...
                    $.each($this.data(), function (i, el) {
                        const parts = i.replace(/([A-Z])/g, ",$1").split(",");
                    ...
                    do // repeatedly expand 'shortcut' validators into their real validators
                    {
                        ...
                        $.each(validatorNamesToInspect, function (i, el) {
                            if ($this.data("validation" + el + "Shortcut") !== undefined) {
                                ...
                                // Pull it out!
                                const validator = settings.builtInValidators[el.toLowerCase()];
                    ...
                    $.each(validatorNames, function (i, el) {
                        ...
                        const hasOverrideMessage = (message !== undefined);
                        ...
                        if (!foundValidator && settings.builtInValidators[el.toLowerCase()]) {
                            ...
                            const validator = $.extend(true, {}, settings.builtInValidators[el.toLowerCase()]);
                    ...
                    $this.bind(
                        ...
                        function (e, params) {
                            ...
                            $controlGroup.find("input,textarea,select").each(function (i, el) {
                                const oldCount = errorsFound.length;
                                ...
                                if (errorsFound.length > oldCount) {
                                    ...
                                    const original = $this.data("original-aria-invalid");
        ...
        validatorTypes: {
            ...
            match: {
                name: "match",
                init: function ($this, name) {
                    let element = $this.parents("form").first().find("[name=\"" + $this.data("validation" + name + "Match") + "\"]").first();
            ...
            maxchecked: {
                name: "maxchecked",
                init: function ($this, name) {
                    const elements = $this.parents("form").first().find("[name=\"" + $this.attr("name") + "\"]");
